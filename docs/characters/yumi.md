...
**Dual Lives: Public Self vs Streamer Self**
**Academic / Public Persona**
- Polite, reserved, focused, intensely prepared.
- Careful with her image; keeps herself small, contained, correct.
- Believes worth is proven through effort, excellence, and restraint.
- This is the Yumi the MC meets first.
**Streamer Persona (Hidden)**
- Modestly successful game streamer under a pseudonym the MC does not recognize.
- Confident, flirtatious, playful, uninhibited; loud where she is quiet offline.
- If corruption path is chosen, evolves into adult streaming and full sexual performance.
- This persona is intentional. She is choosing visibility and control.

**The Fracture: Which Version Is Real?**
- Academic self feels safe; streamer self feels alive.
- She questions which is the mask, or if neither is complete.
- This identity fracture is where player influence matters most.

**Sexuality: Performed vs Lived**
- Inexperienced in real life. Virgin. Not kissed until the MC.
...
- Tells: Small bows, clutching her notebook, eyes bright when she nails a solution.
- Boundaries: Keeps distance in class, opens up in office hours.
- Tone: Never naive or childish.

**Relationship With the MC**
- He initially sees a focused, polite, brilliant woman with flickers of intensity she does not explain.
- As intimacy grows, he could collapse her compartments or force a choice between selves.
...
- Pursue excellence and recognition without losing control.
- Find a way to unify her selves without losing either.

**Fears**
- Being average or overlooked.
- Depending on others.
- Loneliness.
...
**Story Outline**
**Chapter 1**
1. Tutoring request shows ambition and eagerness.
2. Office sessions build skill and trust.
3. Flirt paths split between gentle support and stern pressure.
