...
export const rubyEvents: CharacterEvent[] = [
  {
    ...
    dialogue: {
      ...
      lines: [
        ...
        {
          speaker: "Ruby",
          text: "I caught your last set. Your wrists are caving and your elbows are flaring. That's how people get hurt.",
          expression: "neutral",
        },
        {
          speaker: "Ruby",
          text: "Not trying to be the gym cop. I just don't like watching someone get sidelined over a fixable mistake.",
          expression: "neutral",
        },
        {
          speaker: null,
          text: "She steps closer and demonstrates a small adjustment with her own grip, all business and precision.",
        },
        { speaker: "Ruby", text: "You're working hard, I'll give you that. Sweat looks good on you.", expression: "neutral" },
        {
          speaker: "Ruby",
          text: "But your form's all over the place. It's fixable if you want it to be.",
          expression: "annoyed",
        },
        ...
        {
          speaker: "Ruby",
          text: "Besides, I don't mind an excuse to stick around the gym a little longer.",
          expression: "neutral",
        },
        {
          speaker: null,
          text: "Her smile lingers a beat, like she means it more than she lets on.",
        },
        {
          speaker: null,
  ...
  },
  {
    ...
    dialogue: {
      ...
      lines: [
        ...
        {
          speaker: null,
          text: "You walk outside with her. A car is idling at the curb. A guy steps outâ€”cocky, aggressive.",
        },
        {
          speaker: null,
...
const rubyFinaleComforted = rubyEvents.find(
  (event) => event.id === "ruby_chapter_1_finale_comforted",
)!.dialogue;
const rubyFinaleIndependent = rubyEvents.find(
  (event) => event.id === "ruby_chapter_1_finale_independent",
)!.dialogue;
