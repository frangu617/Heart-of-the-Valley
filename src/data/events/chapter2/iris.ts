...
export const irisEvents: CharacterEvent[] = [
  ...
  // --- REVISED EVENT 2 (ALL PATHS) ---
  {
    ...
    conditions: { requiredFlags: ["irisCh2Ev1_Done"], requiredLocation: "Mall", maxDominance: -10 },
  ...
  },
  {
    ...
    quest: { title: "Chance Encounter", description: "You might run into Iris while out and about." },
    priority: 180, repeatable: false,
    conditions: { requiredFlags: ["irisCh2Ev1_Done"], requiredLocation: "Cafe", minDominance: 10 },
    ...
    quest: { title: "Chance Encounter", description: "You might run into Iris while out and about." },
    priority: 180, repeatable: false,
    conditions: { requiredFlags: ["irisCh2Ev1_Done"], requiredLocation: "Mall", minDominance: -9, maxDominance: 9 }, // Assuming a bookstore is in the mall
