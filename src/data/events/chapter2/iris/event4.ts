...
export const irisEvent4Dialogues: Record<string, Dialogue> = {
  iris_ch2_date_encounter_sub: iris_ch2_date_encounter_sub,
  iris_ch2_date_after_encounter: iris_ch2_date_after_encounter,
  iris_ch2_date_encounter_dom: iris_ch2_date_encounter_dom,
  iris_ch2_date_encounter_neutral: iris_ch2_date_encounter_neutral,
};
